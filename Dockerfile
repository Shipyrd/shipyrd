...
RUN useradd rails --create-home --shell /bin/bash && \
    mkdir db/production db/production_queue db/production_cable && \
    chown -R rails:rails db log storage tmp db/production db/production_queue db/production_cable
